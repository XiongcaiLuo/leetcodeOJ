...
public class Manacher {
    ...
    private int scenter = 0; // the longest palindromic substring, which starts from s[0]. scenter is the farthest center of such substring.
    ...
    public String longestPalindromicSubstring_start(){
    	return s.substring((scenter - 1 - p[scenter]) / 2, (scenter - 1 + p[scenter]) / 2);
    }
    ...
    public static void main(String[] args) {
        ...
        StdOut.println(manacher.longestPalindromicSubstring_start());
